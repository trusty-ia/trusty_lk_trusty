...
$(USER_TASK_SYMS_ELF): $(USER_TASK_LINKER_SCRIPT) $(USER_TASK_CRTBEGIN_OBJS) $(USER_TASK_CRTEND_OBJS) $(ALLUSER_TASKS.$(1).OBJECT) $(2)
	@$(MKDIR)
	@echo linking $$@
	$(NOECHO)$(LD) $(GLOBAL_LDFLAGS) -T $$(PRIVATE_USER_TASK_LINKER_SCRIPT) $$(PRIVATE_USER_TASK_CRTBEGIN_OBJS) $$(PRIVATE_USER_TASK_OBJS) $$(PRIVATE_USER_TASK_DEPS_OBJS) $$(PRIVATE_USER_TASK_CRTEND_OBJS) $(LIBGCC) -o $$@
